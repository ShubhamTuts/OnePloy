...
class CoolifyHelp extends Tool
{
    ...
    protected string $description = 'Tool catalog by intent. Call first when unsure which OnePloy MCP tool to use. Optional intent: overview | search | inventory | debug | deploy | github | team | essentials.';
