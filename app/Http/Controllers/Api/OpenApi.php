...
#[OA\Info(title: 'OnePloy', version: '0.1')]
#[OA\Server(url: 'https://oneploy.dev/api/v1', description: 'OnePloy API. Change the host to your own instance if you are self-hosting.')]
#[OA\SecurityScheme(
    type: 'http',
    scheme: 'bearer',
...
class OpenApi
{
    ...
    // for the OnePloy API. It is not a controller and does
