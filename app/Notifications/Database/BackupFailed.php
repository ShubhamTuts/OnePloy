...
class BackupFailed extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("OnePloy: [ACTION REQUIRED] Database Backup FAILED for {$this->database->name}");
    ...
    {
        $message = "OnePloy: Database backup for {$this->name} (db:{$this->database_name}) with frequency of {$this->frequency} was FAILED.\n\nReason:\n{$this->output}";
