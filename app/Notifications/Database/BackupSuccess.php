...
class BackupSuccess extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("OnePloy: Backup successfully done for {$this->database->name}");
    ...
    {
        $message = "OnePloy: Database backup for {$this->name} (db:{$this->database_name}) with frequency of {$this->frequency} was successful.";
