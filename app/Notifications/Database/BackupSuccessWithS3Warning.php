...
class BackupSuccessWithS3Warning extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("OnePloy: Backup succeeded locally but S3 upload failed for {$this->database->name}");
    ...
    {
        $message = "OnePloy: Database backup for {$this->name} (db:{$this->database_name}) with frequency of {$this->frequency} succeeded locally but failed to upload to S3.\n\nS3 Error:\n{$this->s3_error}";
