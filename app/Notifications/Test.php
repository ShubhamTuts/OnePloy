...
class Test extends Notification implements ShouldQueue
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject('OnePloy: Test Email');
    ...
    public function toDiscord(): DiscordMessage
    {
        $message = new DiscordMessage(
            ...
            description: 'This is a test Discord notification from OnePloy. :cross_mark: :warning: :information_source:',
    ...
    {
        return [
            'message' => 'OnePloy: This is a test Telegram notification from OnePloy.',
            'buttons' => [
                [
    ...
    public function toPushover(): PushoverMessage
    {
        return new PushoverMessage(
            ...
            message: 'This is a test Pushover notification from OnePloy.',
            buttons: [
                [
                    'text' => 'Go to your dashboard',
                    'url' => base_url(),
    ...
    public function toSlack(): SlackMessage
    {
        return new SlackMessage(
            ...
            description: 'This is a test Slack notification from OnePloy.'
        );
    }
    ...
    public function toWebhook(): array
    {
        return [
            'success' => true,
            'message' => 'This is a test webhook notification from OnePloy.',
            'event' => 'test',
            'url' => base_url(),
        ];
    }
