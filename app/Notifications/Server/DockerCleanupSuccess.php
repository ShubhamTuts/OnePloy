...
class DockerCleanupSuccess extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("OnePloy: Docker cleanup job succeeded on {$this->server->name}");
    ...
    public function toDiscord(): DiscordMessage
    {
        return new DiscordMessage(
            title: ':white_check_mark: OnePloy: Docker cleanup job succeeded on '.$this->server->name,
    ...
    {
        return [
            'message' => "OnePloy: Docker cleanup job succeeded on {$this->server->name}!\n\n{$this->message}",
        ];
    }
    ...
    public function toSlack(): SlackMessage
    {
        return new SlackMessage(
            title: 'OnePloy: Docker cleanup job succeeded',
