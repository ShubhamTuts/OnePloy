...
class Unreachable extends CustomEmailNotification
{
    ...
    public function toMail(): ?MailMessage
    {
        ...
        $mail->subject("OnePloy: Your server ({$this->server->name}) is unreachable.");
    ...
    {
        return [
            'message' => "OnePloy: Your server '{$this->server->name}' is unreachable. All automations & integrations are turned off! Please check your server! IMPORTANT: We automatically try to revive your server and turn on all automations & integrations.",
        ];
    }
