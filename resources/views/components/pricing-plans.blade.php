    ...
    <div class="px-6 mx-auto lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-10 md:grid-cols-2 gap-y-28">
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    Once you connected your server, OnePloy will start managing it and do a
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    ...
                    you decide to stop using OnePloy, you can still continue to manage your
                    deployed resources.
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    OnePloy will automatically monitor your configured servers and deployed
